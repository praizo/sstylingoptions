...
?>
            ...
            <div class="container-fluid mx-0 px-0" >
                <div class="row mb-4">
                    <div class="col-12">
                    <?php  
                        $category= $s->getdisplayCategory(5);
                    ?>
                                                    ...
                                                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                                                        <div class="carousel-inner">
                                                            ...
                                                            <div class="carousel-item active">
                                                                <img src="designUpload/<?php echo ($design['photo1']);?>" class="d-block w-100" style="height: 270px;" alt="...">
                                                            </div>
                                                            <div class="carousel-item ">
                                                                <img src="designUpload/<?php echo ($design['photo2']); ?>" class="d-block w-100" style="height: 270px;" alt="...">
                                                            </div>
                                                            <div class="carousel-item ">
                                                                <img src="designUpload/<?php echo ($design['photo3']); ?>" class="d-block w-100" style="height: 270px;" alt="...">
                                                            </div>
                        ...
                        <div class="col-12 my-5" >
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center" >
                                    <li class="page-item ">
                                        <?php if ($page > 1) { ?>
                                        <a style="color:  #f8b500 !important;" class="page-link" href="babies.php?page=<?= $previous; ?> ">Previous</a>
                                    <?php }?>
                                    </li>
                                    <?php 
                                    
                                    $pages= $s->pagination(5);
                            

                                    for ($i=1; $i <= $pages; $i++) : ?>
                                    <li class="page-item"><a style="color:  #f8b500 !important;" class="page-link" href="babies.php?page=<?= $i; ?> "><?= $i; ?></a></li>
                                    <?php endfor; ?>
                                    <li class="page-item">
                                        <?php if ($page < $pages) { ?>
                                        <a style="color:  #f8b500 !important;" class="page-link" href="babies.php?page=<?= $next; ?>">Next</a>
                                        <?php }?>
                                    </li>
                                </ul>
                            </nav>
