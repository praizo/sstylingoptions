...
?>
            ...
            <div class="container-fluid mx-0 px-0" >
                <div class="row mb-4">
                    <div class="col-12">
                    <?php  
                        $category= $s->getdisplayCategory(3);
                    ?>
                        ...
                        <div class="col-12 my-5">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    <li class="page-item ">
                                        <?php if ($page > 1) { ?>
                                        <a style="color:  #f8b500 !important;" class="page-link" href="formal.php?page=<?= $previous; ?>">Previous</a>
                                    <?php }?>
                                    </li>
                                    <?php 
                                    
                                    $pages= $s->pagination(3);
                            

                                    for ($i=1; $i <= $pages; $i++) : ?>
                                    <li class="page-item"><a style="color:  #f8b500 !important;" class="page-link" href="formal.php?page=<?= $i; ?> "><?= $i; ?></a></li>
                                    <?php endfor; ?>
                                    <li class="page-item">
                                        <?php if ($page < $pages) { ?>
                                        <a style="color:  #f8b500 !important;" class="page-link" href="formal.php?page=<?= $next; ?>">Next</a>
                                        <?php }?>
                                    </li>
                                </ul>
                            </nav>
